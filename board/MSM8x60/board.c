...
int board_mmc_init(bd_t *bis)
{
    ...
    mmc_1.host_caps = MMC_MODE_4BIT | MMC_MODE_8BIT | MMC_MODE_HS | MMC_MODE_HS_52MHz;
...
void board_ebi2_init(void)
{
    ...
    /* EBI2 CS2 */
    gpio_tlmm_config(40, 2, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);

    /* EBI2 address */
    gpio_tlmm_config(123, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(124, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(125, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(126, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(127, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(128, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(129, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(130, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);

    /* EBI2 address-data */
    gpio_tlmm_config(135, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(136, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(137, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(138, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(139, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(140, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(141, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(142, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(143, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(144, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(145, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(146, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(147, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(148, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(149, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
    gpio_tlmm_config(150, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);

    /* EBI2 OE */
    gpio_tlmm_config(151, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);

    /* EBI2 WE */
    gpio_tlmm_config(157, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_16MA, GPIO_ENABLE);
}
...
switch (instance) {
//159-166 data 167 clk 168 cmd
case 1:
    /* Some cards had crc erorrs on multiblock reads.
     * Increasing drive strength from 8 to 16 fixed that.
     */
        gpio_tlmm_config(159, 1, GPIO_OUTPUT, GPIO_PULL_UP,GPIO_8MA, GPIO_ENABLE);
