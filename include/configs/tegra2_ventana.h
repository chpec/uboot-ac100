...
#undef TEGRA2_MMC_DEFAULT_DEVICE
#define TEGRA2_MMC_DEFAULT_DEVICE	"1"
...
#define LINUX_MACH_TYPE			MACH_TYPE_VENTANA
...
#define CONFIG_TEGRA2_PINMUX_USB                                \
        ...
        PINMUX(SLXC,  SPDIF,         NORMAL,    TRISTATE)       \
        PINMUX(SLXK,  PCIE,          NORMAL,    TRISTATE)

#define CONFIG_TEGRA2_PINMUX                    \
        CONFIG_TEGRA2_PINMUX_DISPLAY_SEABOARD	\
        CONFIG_TEGRA2_PINMUX_USB
