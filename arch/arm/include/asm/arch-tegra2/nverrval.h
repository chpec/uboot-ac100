...
NVERROR(InvalidArgument,                    0x00030014, "the argument is invalid")
NVERROR(ProcessNotFound,                    0x00030015, "the process is not found")
NVERROR(Deadlock,                           0x00030016, "a deadlock was detected")
#endif
